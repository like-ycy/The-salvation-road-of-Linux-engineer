...
redis 安装成功以后,window下的配置文件保存在软件安装目录下,如果是mac或者linux,则默认安装在/etc/redis/redis.conf
...
![image-20211108102339592](redis.assets/image-20211108102339592.png)
...
![1553246999266](redis.assets/1553246999266.png)
...
![image-20210713111037153](redis.assets/image-20210713111037153.png)
...
列表list：用于保存项目中的列表数据，但是也不能保存多维的列表，例如，消息队列，秒杀系统，排队，
