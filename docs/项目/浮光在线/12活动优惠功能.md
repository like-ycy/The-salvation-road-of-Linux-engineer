...
在admin运营站点中注册活动相关模型管理器，courses/admin.py,代码：
...
因为涉及到时间的计算，所以此处我们需要在settings.dev中设置时区相关的配置信息。
...
```sql
INSERT INTO fuguang.fg_activity (id, name, orders, is_show, is_delete, created_time, updated_time, start_time, end_time, description, remark) VALUES (1, '浮光在线-1周年庆', 1, 1, 0, '2021-07-29 10:42:54.340893', '2021-07-29 10:42:54.340933', '2021-07-29 00:00:00', '2021-08-01 00:00:00', '<p><img alt="" src="/uploads/ckeditor/2021/07/29/d2c059da6e09b35a.gif" style="height:180px; width:1125px" /></p>', '负责人：
组织：
外勤：');

INSERT INTO fuguang.fg_discount_type (id, name, orders, is_show, is_delete, created_time, updated_time, remark) VALUES (1, '免费', 1, 1, 0, '2021-07-29 10:43:38.546870', '2021-07-29 10:43:38.546901', null);
INSERT INTO fuguang.fg_discount_type (id, name, orders, is_show, is_delete, created_time, updated_time, remark) VALUES (2, '折扣', 1, 1, 0, '2021-07-29 10:43:49.161997', '2021-07-29 11:19:58.799363', null);
INSERT INTO fuguang.fg_discount_type (id, name, orders, is_show, is_delete, created_time, updated_time, remark) VALUES (3, '减免', 1, 1, 0, '2021-07-29 10:44:05.712935', '2021-07-29 11:41:16.504340', null);
INSERT INTO fuguang.fg_discount_type (id, name, orders, is_show, is_delete, created_time, updated_time, remark) VALUES (4, '限时免费', 1, 1, 0, '2021-07-29 10:44:23.053845', '2021-07-29 10:44:23.053925', null);
INSERT INTO fuguang.fg_discount_type (id, name, orders, is_show, is_delete, created_time, updated_time, remark) VALUES (5, '限时折扣', 1, 1, 0, '2021-07-29 10:44:31.999352', '2021-07-29 10:44:31.999382', null);
INSERT INTO fuguang.fg_discount_type (id, name, orders, is_show, is_delete, created_time, updated_time, remark) VALUES (6, '限时减免', 1, 1, 0, '2021-07-29 10:44:39.100270', '2021-07-29 10:44:39.100305', null);


INSERT INTO fuguang.fg_discount (id, name, orders, is_show, is_delete, created_time, updated_time, `condition`, sale, discount_type_id) VALUES (1, '免费购买', 1, 1, 0, '2021-07-29 10:45:54.027034', '2021-07-29 10:45:54.027079', 0, '0', 4);
INSERT INTO fuguang.fg_discount (id, name, orders, is_show, is_delete, created_time, updated_time, `condition`, sale, discount_type_id) VALUES (2, '九折折扣', 1, 1, 0, '2021-07-29 10:47:12.855454', '2021-07-29 11:32:27.148655', 1, '*0.9', 2);
INSERT INTO fuguang.fg_discount (id, name, orders, is_show, is_delete, created_time, updated_time, `condition`, sale, discount_type_id) VALUES (3, '课程减免100', 1, 1, 0, '2021-07-29 11:40:44.499026', '2021-07-29 11:40:44.499060', 300, '-100', 3);


INSERT INTO fuguang.fg_course_activity_price (id, name, orders, is_show, is_delete, created_time, updated_time, activity_id, course_id, discount_id) VALUES (1, '九折-3天Typescript', 1, 1, 0, '2021-07-29 10:48:12.600755', '2021-07-29 10:48:12.600801', 1, 2, 2);
INSERT INTO fuguang.fg_course_activity_price (id, name, orders, is_show, is_delete, created_time, updated_time, activity_id, course_id, discount_id) VALUES (2, '免费送课', 1, 1, 0, '2021-07-29 11:36:34.192896', '2021-07-29 11:36:34.192941', 1, 1, 1);
INSERT INTO fuguang.fg_course_activity_price (id, name, orders, is_show, is_delete, created_time, updated_time, activity_id, course_id, discount_id) VALUES (3, '减免课程', 1, 1, 0, '2021-07-29 11:40:49.240245', '2021-07-29 11:40:49.240276', 1, 3, 3);
```
